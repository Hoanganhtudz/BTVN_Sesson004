...
var sv1 = new sinhVien('tú', 19, 1, 'nam dinh','A1',10,10,10)
sv1.hienThi();
var sv2 = new sinhVien('thiện', 19, 2, 'chương mỹ','A2',4,4,4)
sv2.hienThi();
var sv3 = new sinhVien('yến', 1, 2, 'sóc trăng','A3',9,6,7)
sv3.hienThi();
var sv4 = new sinhVien('hậu môn', 5, 3, 'sóc sơn','A4',7,9,7)
sv4.hienThi();
...
var nv1 = new NhanVien('tú', 19, 1, 'nam dinh','A1',200000,29)
nv1.nhanVien();
var nv2 = new NhanVien('thiện', 19, 2, 'chương mỹ','A2',400000,26)
nv2.nhanVien();
var nv3 = new NhanVien('yến', 1, 2, 'sóc trăng','A3',120000,30)
nv3.nhanVien();
var nv4 = new NhanVien('hậu môn', 5, 3, 'sóc sơn','A4',100000,30)
nv4.nhanVien();